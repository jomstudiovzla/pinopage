const CACHE_NAME = 'pino-ev-v40-apple-100-percent-scanner-hardened'; // pino-ev-v39-zero-errors-orchestrated-master pino-ev-v24 pino-ev-v21 pino-ev-v20-turbo-europe pino-ev-v19
const ASSETS = [
  './index.html',
  './manifest.json',
