...
assert(swJs.includes('pino-ev-v21') || swJs.includes('pino-ev-v22') || swJs.includes('pino-ev-v23') || swJs.includes('pino-ev-v24'), 'sw.js utilise le cache v21 ou supérieur');
